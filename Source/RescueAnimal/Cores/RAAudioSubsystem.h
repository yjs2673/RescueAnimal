...
#include "RAAudioSubsystem.generated.h"
...
UCLASS(Config = Game, DefaultConfig, meta = (DisplayName = "Rescue Animal Audio"))
class RESCUEANIMAL_API URAAudioSubsystemSettings : public UDeveloperSettings
{
	GENERATED_BODY()
...
UCLASS()
class RESCUEANIMAL_API URAAudioSettingsSaveGame : public USaveGame
{
	GENERATED_BODY()
...
UCLASS()
class RESCUEANIMAL_API URAAudioSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY()
	FString SettingsSaveSlotName = TEXT("RescueAnimalAudioSettings");
