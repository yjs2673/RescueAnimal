...
UCLASS()
class RESCUEANIMAL_API AEnemyCampActor : public AActor
{
	GENERATED_BODY()
...
public:
	...
	void RegisterEnemy(ARAEnemyBase* Enemy);
	...
	UFUNCTION(BlueprintPure, Category = "Camp")
	TArray<ARAEnemyBase*> GetCampEnemies() const;
...
protected:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Camp")
	TArray<TObjectPtr<ARAEnemyBase>> CampEnemies;
